            ...
            child: Column(
              children: [
                ...
                AnimatedButton(
                  ...
                  text: 'Comenzar Quiz',
                  pressEvent: () {
                    if (txtQuizId.text.isEmpty || txtTeacherId.text.isEmpty) {
                      toast("Ingrese los codigos correspondientes",
                          Colors.red[400], Colors.white, 14);
                    } else {
                      AwesomeDialog(
                        context: context,
                        ...
                        title: 'Confirmacion',
                        desc: 'Estas apunto de comenzar el Quiz. Estas Seguro?',
                        showCloseIcon: true,
                        btnCancelOnPress: () {},
                        btnOkOnPress: () {
                          Navigator.push(
